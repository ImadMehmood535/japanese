              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="mt-6">
                    <Link
                      href="/cart"
                      className="flex GeneralSans  items-center justify-center rounded-md border border-transparent px-6 py-3 text-base font-medium text-white shadow-sm bg-black hover:bg-themeSecondary-0"
                    >
                      Cart
                    </Link>
                  </div>
                  <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                    <p>
                      ...
                      <button
                        type="button"
                        className="font-medium text-themeSecondary-0"
                      >
                        Continue Shopping
