    ...
    <div className="ReviewCart">
      <div className="grid grid-cols-2 gap-4">
        <div className="image-area">
          <div className="border rounded-2xl border-black h-full overflow-hidden">
            <Image
        ...
        <div className="content-area ">
          <div className="border rounded-2xl border-black py-4 px-2">
            <p className="text-black text-center text-lg mb-3">
              {review.review}
            </p>
